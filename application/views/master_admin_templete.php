...
<body class="home">
    ...
    <?php include 'application/views/master/includes/header.php'; ?>

    <!-- Page content -->
    <div class="page-content">
        <!-- START SIDEBAR SECTION -->
        <?php include 'application/views/master/includes/sidebar.php'; ?>
        ...
        <div class="content-wrapper">
            ...
            <!-- START FOOTER -->
            <?php include 'application/views/master/includes/footer.php'; ?>
            <!-- END FOOTER -->
