    ...
    <div class="row justify-content-md-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo base_url('admin/product_edit/' . $product->pro_id); ?>" class="page_form" enctype="multipart/form-data" method="POST">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="productId" name="productId" class="form-control" placeholder="Product ID" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="meta_description" id="meta_description" class="form-control" cols="30" rows="5"><?php echo $product->meta_description; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="meta_keywords" id="meta_keywords" class="form-control" cols="30" rows="5"><?php echo $product->meta_keywords; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="#" class="dropzone" id="dropzone_remove_cust">
                        ...
                        <input type="hidden" name="reference_id" value="<?php echo $product->pro_id; ?>">
                    </form>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            if ($images) {
                                foreach ($images as $item) {
                                    $i++; ?>
                                    <tr data-image_id="<?php echo $item->image_id; ?>" data-reference_id="<?php echo $item->reference_id; ?>">
                                        <td width="10%"><?php echo $i; ?></td>
                                        <td>
                                            <a href="<?php echo site_url($item->path . $item->image); ?>" target="_blank">
                                                <img src="<?php echo site_url($item->path . $item->image); ?>" width="150" height="150" alt="" loading="lazy">
                                            </a>
                                        </td>
                                        <td><input type="text" class="form-control image_title" value="<?php echo $item->title; ?>"></td>
                                        <td><input type="number" class="form-control image_order" value="<?php echo $item->image_order; ?>"></td>
                                        <td>
...
<script>
    $(document).ready(function() {
        $('#productId').val('<?php echo $product->productId; ?>');
        $('#brandName').val('<?php echo $product->brandName; ?>');
        $('#pro_weight').val('<?php echo $product->pro_weight; ?>');
        $('#salesPrice').val('<?php echo $product->salesPrice; ?>');

        $('#pro_category').val('<?php echo $product->pro_category; ?>').change();
        $('#formulationId').val('<?php echo $product->formulationId; ?>').change();
        $('#pro_genericId').val('<?php echo $product->pro_genericId; ?>').change();
        $('#pro_company').val('<?php echo $product->pro_company; ?>').change();
    });
