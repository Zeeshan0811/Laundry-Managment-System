...
<body class="home">
    ...
    <?php include 'application/views/customer/includes/header.php'; ?>

    <!-- Page content -->
    <div class="page-content">
        <!-- START SIDEBAR SECTION -->
        <?php include 'application/views/customer/includes/sidebar.php'; ?>
        ...
        <div class="content-wrapper">
            ...
            <!-- START FOOTER -->
            <?php include 'application/views/customer/includes/footer.php'; ?>
            <!-- END FOOTER -->
