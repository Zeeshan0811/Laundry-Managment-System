        ...
        if (isPostBack()) {
            ...
            if (!empty($userInfo)) {
                ...
                if ($userInfo->type < 4) {
                    ...
                    $vendor = $this->CommonModel->table_info('nso_vendors', 'vendor_id', $user_vendor_access->company_id);

                    if ($vendor->vendor_status != 1) {
                        $this->session->set_flashdata('login_msg', 'You are not authorized to access!');
                        redirect(base_url('login'));
                    }
                    ...
                    $vendor = $this->CommonModel->table_info('nso_vendors', 'vendor_id', $user_vendor_access->vendor_id);
